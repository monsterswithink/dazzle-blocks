...
import { Mail, Linkedin, Globe, MapPin, Calendar, ChevronDown, ChevronRight } from "lucide-react"
...
function ExperienceItem({ exp }: { exp: EnrichedProfile["experiences"][0] }) {
    ...
    <div className="border border-gray-200 rounded-md overflow-hidden">
      ...
      >
        <div className="text-left">
          <p className="font-semibold text-base">{exp.title || "Untitled Role"}</p>
