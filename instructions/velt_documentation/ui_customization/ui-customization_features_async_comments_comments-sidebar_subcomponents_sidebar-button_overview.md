...
URL Source: https://docs.velt.dev/ui-customization/features/async/comments/comments-sidebar/subcomponents/sidebar-button/overview
...
[​](https://docs.velt.dev/ui-customization/features/async/comments/comments-sidebar/subcomponents/sidebar-button/overview#default-component)

Default Component
---------------------------------------------------------------------------------------------------------------------------------------------------------------

Here’s how the default sidebar button looks like:![Image 4](https://mintlify.s3.us-west-1.amazonaws.com/velt/images/sidebar-button-light.png)

Was this page helpful?

Yes No

[Reset filter button](https://docs.velt.dev/ui-customization/features/async/comments/comments-sidebar/subcomponents/reset-filter-button)[Styling](https://docs.velt.dev/ui-customization/features/async/comments/comments-sidebar/subcomponents/sidebar-button/styling)
...
![Image 5](https://mintlify.s3.us-west-1.amazonaws.com/velt/images/sidebar-button-light.png)
